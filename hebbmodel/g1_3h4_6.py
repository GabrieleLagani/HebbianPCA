...
class Net(nn.Module):
	...
	def __init__(self, config, input_shape=P.INPUT_SHAPE):
		...
		self.net_g1_3 = basemodel.model3.Net(config, input_shape)
		...
		self.net_h4_6 = hebbmodel.top3.Net(config, utils.get_output_fmap_shape(self.net_g1_3, basemodel.model3.Net.BN3))
