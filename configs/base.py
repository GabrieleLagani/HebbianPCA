...
fc_on_gdes_layer = {
	...
	P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/base/config_1l/iter' + P.STR_TOKEN + '/models/model0.pt'],
...
fc_on_hebb_layer = {
	...
	P.KEY_PRE_NET_MDL_PATHS: [P.PROJECT_ROOT + '/results/configs/base/config_1l_hebb/iter' + P.STR_TOKEN + '/models/model0.pt'],
	P.KEY_PRE_NET_OUTPUTS: ['bn1'],
}
