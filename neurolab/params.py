...
DEFAULT_CONVTHRESHOLDS = [0.05, 0.02] # Percentage levels to be used to measure at which training epoch the result has reached a given percentage of the best result (i.e. the convercence time).
