...
# This is a utility script that takes a path to a desired result folder as input, reads the results saved in this
...
def run_dispconv(path, label, crit, seeds, ci_levels, savepath, fillbetw):
	...
	for i in range(len(path)):
		for id in seeds:
			checkpoint_folder = os.path.join(path[i], 'iter_' + str(id), 'checkpoints')
